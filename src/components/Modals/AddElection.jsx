        ...
        <style>
            ...
            <SubCon>
                ...
                <Form onSubmit={handleSubmit(onSubmit)}>
                    <FormLabel>
                        Election Theme:
                        <FormDataComp type={"text"} {...register("theme", {required:true})}/>
                    </FormLabel>
                    ...
                    <DbInput>
                        <FormLabel>
                            Election Start Time:
                            <FormDataComp type={"time"} {...register("startDate", {required:true})}/>
                        </FormLabel>
                    ...
                    <FormLabel>
                        ...
                        <FormTextArea {...register("instructions", {required:true})}/>
                    </FormLabel>

                    <SubConBtnHold>
                        <SubConBtn type={"submit"} value="Submit" typex="filled"/>
