...
const AddNews = ({close}) => {
  ...
  const { isLoading:createLoading, mutate:createMutate } = useMutation((newsData)=>createNews(newsData), {
    onMutate: () => {
        toast.info("News Creation in progress",{progressClassName:"toastProgress",icon:false})
    },
    onSuccess: () => {
        toast.success("News Created",{progressClassName:"toastProgress",icon:false})
        ...
        <SubCon>
            ...
            <Form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    fields.map((field, index) => {
                        return (
                            <section key={field.id}>
                                <FormLabel>
                                    Heading:
                                    <FormDataComp type={"text"} {...register(`news_paragraph.${index}.heading`)}/>
                                </FormLabel>
                ...
                <SubConBtnHold>
                    ...
                    <SubConBtn type={"button"} value="Cancel" disabled={createLoading} onClick={close}/>
                </SubConBtnHold>
            </Form>
        </SubCon>
